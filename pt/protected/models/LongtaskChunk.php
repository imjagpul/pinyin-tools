...
class LongtaskChunk extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, longtask_id, input', 'required'),
			array('id, longtask_id', 'numerical', 'integerOnly'=>true),
			array('result', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, longtask_id, input, result', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('longtask_id',$this->longtask_id);
