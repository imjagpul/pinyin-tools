...
echo '<p></p>';
      ?><div class="ch s"><?php echo self::linkify($entry->getText(CharacterMode::CHARMOD_SIMPLIFIED_ONLY)); 
?></div><div class="ch t"><?php echo self::linkify($entry->getText(CharacterMode::CHARMOD_TRADITIONAL_ONLY)); 
