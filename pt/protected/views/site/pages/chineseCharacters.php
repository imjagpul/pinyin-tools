...
<p>That is why I've decided to <?php echo CHtml::link('publicate them', array('system/view', 'id'=>2)); ?> 
(I've learned over 4500 characters, so it is quite a collection.)  
That is what this website is for: everybody can write (and optionally share) the mnemonics. Hopefully will the content on this site boost your Chinese studies!