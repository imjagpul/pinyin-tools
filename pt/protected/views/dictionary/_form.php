...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'transcriptionId'); ?>
		<?php echo $form->textField($model,'transcriptionId'); ?>
		<?php echo $form->error($model,'transcriptionId'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'targetLanguageId'); ?>
		<?php echo $form->textField($model,'targetLanguageId'); ?>
		<?php echo $form->error($model,'targetLanguageId'); ?>
	</div>
